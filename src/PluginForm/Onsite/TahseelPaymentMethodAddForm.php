...
use Drupal\commerce_tahseel\Plugin\Commerce\PaymentMethodType\TahseelPaymentMethod;

class TahseelPaymentMethodAddForm extends BasePaymentMethodAddForm {
  ...
  public function buildEcheckForm(array $element, FormStateInterface $form_state) {
    ...
    $element['account_type'] = [
      ...
      '#options' => TahseelPaymentMethod::getAccountTypes(),
    ];
