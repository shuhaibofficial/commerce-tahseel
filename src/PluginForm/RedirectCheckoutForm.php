...
namespace Drupal\commerce_tahseel_gateway\PluginForm;

use Drupal\commerce_payment\PluginForm\PaymentOffsiteForm;
use Drupal\commerce_tahseel_gateway\CurrencyCalculator;
...
class RedirectCheckoutForm extends PaymentOffsiteForm implements ContainerInjectionInterface {
  ...
  public static function create(ContainerInterface $container) {
    return new static(
      $container->get('commerce_tahseel_gateway.currency_calculator')
    );
  }
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    $data['version'] = 'v10';
    $data['national_id'] = $configuration['national_id'];
    $data['iqama_id'] = $configuration['iqama_id'];
    ...
    $data['callbackurl'] = Url::fromRoute('commerce_tahseel_gateway.callback', [], ['absolute' => TRUE])->toString();
  ...
  private function getConfiguration() {
    ...
    /** @var \Drupal\commerce_tahseel_gateway\Plugin\Commerce\PaymentGateway\RedirectCheckout $payment_gateway_plugin */
